...
@DataJpaTest
public class ClienteModifyClienteTest {
	@Autowired
	...
	@Test
	public void cuandoModifyClienteExistenteFindAllEntonces5() {
		this.x.save(new Cliente("1-9", "Romina", "Roman", "asd@asd.cl", "1234123"));
